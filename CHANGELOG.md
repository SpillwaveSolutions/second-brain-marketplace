...
- Pin **data-engineering-knowledge-capture 0.5.0** (retrieval ladder: disposable SQLite/FTS5 index + ripgrep prefilter; JSON `knowledge/.index/` removed). Merge: [data-engineering-knowledge-capture#49](https://github.com/SpillwaveSolutions/data-engineering-knowledge-capture/pull/49).
